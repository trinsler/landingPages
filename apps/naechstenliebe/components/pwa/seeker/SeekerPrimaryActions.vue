  ...
  <div style="margin-bottom: 1.5rem;">
    ...
    >
      <div style="display: flex; align-items: center; justify-content: center; gap: 0.5rem;">
        <img src="/icons/verschiedeneMenschen.svg" alt="Als Helfer aktiv werden" style="width: 1.25rem; height: 1.25rem;">
...
<script setup>
defineEmits(['create-task', 'become-helper'])
</script>