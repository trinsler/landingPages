<template>
  <nav
    ...
    :class="[scrolled ? 'cyber-card shadow-2xl' : 'bg-transparent', 'backdrop-blur-xl']"
  >
      ...
      <div class="flex justify-between items-center py-4 lg:py-6">
        ...
        <div class="flex items-center">
          <NuxtLink to="/" class="group flex items-center space-x-3">
            <div class="relative">
              <div
                class="w-10 h-10 lg:w-12 lg:h-12 rounded-xl neon-card flex items-center justify-center group-hover:scale-110 transition-transform duration-300 animate-neon-flicker overflow-hidden"
              >
                <img
            ...
            <div class="hidden sm:block">
              <span
                class="text-xl lg:text-2xl font-black text-white"
                style="font-family: 'Space Grotesk', sans-serif"
              >
                <span class="text-accent-neon">TRINS</span><span class="text-accent-cyan">LER</span>
              </span>
              <div class="text-xs font-medium text-accent-cyan">Web Development</div>
            </div>
          </NuxtLink>
        </div>
        ...
        <div class="hidden lg:flex items-center space-x-8">
          ...
          >
            {{ item.name }}
            <div
              class="absolute bottom-0 left-0 w-0 h-0.5 bg-accent-primary group-hover:w-full transition-all duration-300"
            />
          </NuxtLink>
        </div>
        ...
        <div class="flex items-center space-x-4">
          ...
          <div class="hidden lg:flex items-center space-x-4">
            ...
            >
              <span class="relative z-10 text-sm font-medium code-font"> 🎨 Theme Test </span>
              <div
                class="absolute inset-0 rounded-xl bg-accent-cyan/5 group-hover:bg-accent-cyan/10 transition-colors duration-300"
              />
            </NuxtLink>

            <NuxtLink to="/contact" class="btn-primary group relative overflow-hidden">
            ...
            <div class="absolute inset-0 flex items-center justify-center">
              <div class="w-5 h-5 relative">
                <span
                  ...
                  :class="[mobileMenuOpen ? 'rotate-45 translate-y-0' : '-translate-y-1']"
                />
                <span
