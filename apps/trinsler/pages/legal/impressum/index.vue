    ...
    <div class="relative container-custom py-20">
      ...
      <div class="cyber-card rounded-3xl overflow-hidden max-w-4xl mx-auto mb-12">
        ...
        <div class="p-8 lg:p-12">
          <h1 class="text-4xl font-black text-white mb-8 text-center">
            <span class="text-accent-primary">Impressum</span>
          </h1>
          ...
          <div class="space-y-8">
            ...
            <div class="neon-card rounded-xl p-6">
              <h2 class="text-xl font-bold text-white mb-4">Angaben gemäß § 5 TMG</h2>
              <div class="space-y-3 text-white/90">
                <p><strong>Trinsler GmbH</strong></p>
                <p>Geschäftsführer: Max Mustermann, Anna Schmidt</p>
            ...
            <div class="cyber-card rounded-xl p-6">
              <h2 class="text-xl font-bold text-white mb-4">Kontakt</h2>
              <div class="space-y-3 text-white/90">
                <p><strong>Telefon:</strong> +49 30 12345678</p>
                <p><strong>E-Mail:</strong> hello@trinsler.de</p>
                <p><strong>Website:</strong> www.trinsler.de</p>
              </div>
            </div>

            <!-- Legal Information -->
            <div class="glass-card rounded-xl p-6">
              <h2 class="text-xl font-bold text-white mb-4">Registereintrag</h2>
              <div class="space-y-3 text-white/90">
